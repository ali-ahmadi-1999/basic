    ...
    <div class="container-xxl">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1 text-end">
                <h4 class="fs-18 fw-semibold m-0">ویرایش  اسلایدر</h4>
            </div>
        </div>
                ...
                <div class="card border mb-0">
                    ...
                    <div class="card-header text-end">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="card-title mb-0"> اسلایدر   </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('update.review', $slider->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3 text-end">
                                ...
                                <input class="form-control text-end" name="title" value="{{ $slider->title }}" type="text">
                           @error('title')
                            ...
                            <div class="form-group mb-3 text-end">
                                ...
                                <input class="form-control text-end" name="description" value="{{ $slider->description }}" type="text">
                             @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            </div>
