                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('custom.verification.verify') }}" class="my-4">
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="emailaddress" class="form-label">کد تایید</label>
                                                <input class="form-control" type="text" id="code" name="code" required="" placeholder=" کد تایید خود را ارسال کنید ">
                                                @error('code')
