                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">همه را بیازمودم

ز تو خوش ترم نیامد</h3>
                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('register') }}" class="my-4">
                                            @csrf
                                             ...
                                             <div class="form-group mb-3">
                                                <label for="emailaddress" class="form-label"> نام </label>
                                                <input class="form-control" type="text" id="name" name="name" required="" placeholder="نام خود را وارد کنید  ">
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="password" required=""  name="password_confirmation" id="password_confirmation" placeholder=" تکرار رمز عبور  ">
                                            </div>
                                        ...
                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">فرم صفحه ورود <a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'> ورود </a></p>
                                        </div>
